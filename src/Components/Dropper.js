...
const Dropper = () => {
  ...
  return (
    <>
    <div className=" border-4 rounded-md  p-2 px-4">
      ...
      <div className="grid grid-cols-2 gap-2 md:grid-cols-none md:flex md:space-y-4 md:flex-col flex-none my-4 items-center w-auto justify-center justify-items-center content-center ">
        <div className="w-full rounded flex  ">
          <div
            className={` flex gap-2  text-black font-bold border w-full  text-center items-center rounded-md p-6`}
            onDragStart={(event) =>
        ...
        <div
          className="bg-[Black]  text-white font-bold rounded-md w-full p-6"
          onDragStart={(event) =>
        ...
        <div
          className="bg-[#ccd9f6]  text-black font-bold rounded-md w-full p-6"
          onDragStart={(event) =>
